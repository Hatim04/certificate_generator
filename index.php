...
<div class="container text-center my-5 ">
    ...
    <a href="form.php" class="bg-green-400  custom text-white font-semibold py-4 px-8 mr-6 mb-6 rounded-lg text-2xl  inline-block">Add User</a>
    ...
    <a href="one.php" class="bg-green-400  custom text-white font-semibold py-4 px-8 ml-6 mt-6 mb-6 mr-6 rounded-lg text-2xl  inline-block">Delete User</a>
    <a href="mailto:khevlanidipak1@gmail.com?cc=&subject=certificate"class="bg-green-400 mb-6 mr-6 custom ml-4 text-white font-semibold py-4 px-8 rounded-lg text-2xl  inline-block">Send mail</a>    
    <p class="mt-4">
